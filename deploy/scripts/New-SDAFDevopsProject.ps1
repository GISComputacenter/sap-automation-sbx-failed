...
if ($Project_ID.Length -eq 0) {
  ...
  az repos import create --git-url https://github.com/GISComputacenter/SAP-automation-bootstrap --repository $repo_id --output none
...
if ($confirmation -ne 'y') {
  ...
  az repos import create --git-url https://github.com/GISComputacenter/SAP-automation --repository $code_repo_id --output none
  ...
  az repos import create --git-url https://github.com/GISComputacenter/SAP-automation-samples --repository $sample_repo_id --output none
  ...
  Add-Content -Path $templatename "      name: GISComputacenter/sap-automation"
  Add-Content -Path $templatename "     ref: refs/heads/main"
#  Add-Content -Path $templatename -Value ("      ref: refs/tags/" + $versionLabel)
  ...
  Add-Content -Path $templatename "     type: GitHub"
  Add-Content -Path $templatename -Value ("     endpoint: " + $ghConn)
  Add-Content -Path $templatename "     name: GISComputacenter/sap-automation-samples"
  Add-Content -Path $templatename "     ref: refs/heads/main"
