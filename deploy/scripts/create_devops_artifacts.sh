...
if [ -z $id ]; then
  ...
  az repos import create --git-url https://github.com/GISComputacenter/sap-automation-bootstrap.git --org  $ADO_ORGANIZATION --project $id --repository $repo_id --output none
